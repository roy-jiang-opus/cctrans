...
[English](README.md) | [简体中文](README.zh-CN.md) | [繁體中文](README.zh-TW.md) | [日本語](README.ja.md) | [한국어](README.ko.md) | [Русский](README.ru.md) | **हिन्दी**
...
cd cctranslate
node bin/tt.js install      # हुक को ~/.claude/settings.json में पंजीकृत करता है और tt को ~/.local/bin में लिंक करता है
```
...
|--------|--------|-----|----------|---------|
| `openai` (key होने पर डिफ़ॉल्ट) | `OPENAI_API_KEY` | ~1.4s/खंड | उच्च | `gpt-4o-mini` बैच पंक्ति अनुवाद, कोड/पथ सुरक्षित |
| `anthropic` | `ANTHROPIC_API_KEY` | ~1s/खंड | उच्च | `claude-haiku-4-5` + structured outputs, सख़्त समान-लंबाई पंक्ति सरणियाँ (~$0.0005/खंड) |
| `deepl` | `DEEPL_API_KEY` (मुफ़्त: 5 लाख वर्ण/माह) | ~0.5s/खंड | उच्च | सर्वश्रेष्ठ पारंपरिक MT; array API से पंक्तियाँ स्वतः संरेखित |
| `azure` | `AZURE_TRANSLATOR_KEY` (मुफ़्त: 20 लाख वर्ण/माह) | ~0.5s/खंड | मध्यम-उच्च | वैकल्पिक `AZURE_TRANSLATOR_REGION` |
...
पर्यावरण चर: `TT_BACKEND`, `TT_TARGET` (डिफ़ॉल्ट `zh-Hans`), `TT_MARKER` (डिफ़ॉल्ट `↳ `), `TT_HOME` (डिफ़ॉल्ट `~/.cc-translate`), `TT_OPENAI_MODEL`, `TT_ANTHROPIC_MODEL`, `AZURE_TRANSLATOR_ENDPOINT`।
