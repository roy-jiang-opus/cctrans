...
API कुंजियाँ `~/.cc-translate/keys.json` (chmod 600) में रहती हैं और `tt setup` या `tt key` से सेट होती हैं — शेल के `OPENAI_API_KEY` जैसे चर डिफ़ॉल्ट रूप से **नहीं पढ़े जाते**, इसलिए इस टूल की कुंजियाँ और टर्मिनल की कुंजियाँ एक-दूसरे को दूषित नहीं करतीं। `tt setup` पाई गई env कुंजियों के आयात का प्रस्ताव देता है; सामान्य env पढ़ने के लिए `TT_USE_ENV_KEYS=1`, और `TT_OPENAI_KEY` शैली के ओवरराइड हमेशा काम करते हैं।
