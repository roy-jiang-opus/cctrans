...
| `cctrans only [on\|off]` | **केवल** अनुवाद दिखाएँ, अंग्रेज़ी छिपाते हुए (line मोड + replace) |
...
**सिर्फ़ अपनी भाषा चाहिए, अंग्रेज़ी बिलकुल नहीं?** `cctrans only on` ठीक इसी के लिए एक-कमांड शॉर्टकट है (यह line मोड + replace सेट कर देता है)। अंग्रेज़ी एक पल को भी नहीं झलकती — Claude Code हर पंक्ति को पहले से अनुवादित ही रेंडर करता है — और जिस पंक्ति का अनुवाद न हो सके, वह अंग्रेज़ी पर लौट आती है; कोड ब्लॉक बिना बदलाव के गुज़र जाते हैं। `cctrans only off` द्विभाषी पर वापस ले आता है।
